# Rubric validation (rubric v1.1.0)
...
|---|---|---|---|---|
| security | 20 | **0.32** | -0.25 – 0.71 | 0.0778 |
| dependencies | 20 | **0.42** | -0.06 – 0.80 | 0.0328 |
| architecture | 20 | **-0.16** | -0.63 – 0.31 | 0.7451 |
| code_health | 13 | **0.34** | -0.30 – 0.80 | 0.1178 |
| overall | 20 | **0.66** | 0.28 – 0.87 | 0.0006 |
...
| fastapi/full-stack-fastapi-template | mature | 94.0 | 1.3 | 88.5 | 98.2 | 75.2 | 4/5/5/5/5 |
...
## Inversions (labels differ by ≥ 2, scores disagree): 142
...
- **dependencies**: fastapi/full-stack-fastapi-template (label 5, score 1.3) < appsecco/dvna (label 1, score 100.0)
...
- **dependencies**: fastapi/full-stack-fastapi-template (label 5, score 1.3) < miguelgrinberg/microblog (label 3, score 1.4)
- **dependencies**: fastapi/full-stack-fastapi-template (label 5, score 1.3) < gothinkster/django-realworld-example-app (label 1, score 7.1)
- **dependencies**: fastapi/full-stack-fastapi-template (label 5, score 1.3) < mjhea0/flaskr-tdd (label 3, score 42.3)
...
- **overall**: fastapi/full-stack-fastapi-template (label 5, score 75.2) < mjhea0/flaskr-tdd (label 3, score 76.0)
...
|---|---|---|---|---|---|
| **as shipped** | 0.32 | 0.42 | -0.16 | 0.34 | 0.66 |
| security weight ×0.5 | 0.32 | 0.42 | -0.16 | 0.34 | 0.60 |
| security half-life ×0.5 | 0.32 | 0.42 | -0.16 | 0.34 | 0.62 |
| security weight ×1.5 | 0.32 | 0.42 | -0.16 | 0.34 | 0.61 |
| security half-life ×1.5 | 0.32 | 0.42 | -0.16 | 0.34 | 0.68 |
| dependencies weight ×0.5 | 0.32 | 0.42 | -0.16 | 0.34 | 0.58 |
| dependencies half-life ×0.5 | 0.32 | 0.42 | -0.16 | 0.34 | 0.67 |
| dependencies weight ×1.5 | 0.32 | 0.42 | -0.16 | 0.34 | 0.68 |
| dependencies half-life ×1.5 | 0.32 | 0.42 | -0.16 | 0.34 | 0.67 |
| architecture weight ×0.5 | 0.32 | 0.42 | -0.16 | 0.34 | 0.70 |
| architecture half-life ×0.5 | 0.32 | 0.42 | -0.16 | 0.34 | 0.66 |
| architecture weight ×1.5 | 0.32 | 0.42 | -0.16 | 0.34 | 0.65 |
| architecture half-life ×1.5 | 0.32 | 0.42 | -0.16 | 0.34 | 0.68 |
| code_health weight ×0.5 | 0.32 | 0.42 | -0.16 | 0.34 | 0.67 |
| code_health half-life ×0.5 | 0.32 | 0.42 | -0.16 | 0.34 | 0.67 |
| code_health weight ×1.5 | 0.32 | 0.42 | -0.16 | 0.34 | 0.66 |
| code_health half-life ×1.5 | 0.32 | 0.42 | -0.16 | 0.34 | 0.64 |
| repeat damping exponent 0.5 | 0.27 | 0.42 | -0.12 | 0.24 | 0.55 |
| repeat damping exponent 1.0 | 0.34 | 0.42 | -0.17 | 0.34 | 0.73 |
| no repeat damping (exponent 0) | -0.25 | 0.40 | -0.18 | 0.13 | 0.10 |
| test-path factor 0.05 | 0.32 | 0.42 | -0.16 | 0.36 | 0.70 |
| test-path factor 1.0 | 0.32 | 0.30 | -0.16 | 0.20 | 0.60 |
| corroboration factor 1.0 | 0.31 | 0.42 | -0.16 | 0.34 | 0.63 |
| equal category weights | 0.32 | 0.42 | -0.16 | 0.34 | 0.60 |
| flat severity weights | 0.13 | 0.42 | 0.07 | 0.20 | 0.68 |
| no size normalisation | 0.14 | 0.42 | -0.28 | -0.14 | 0.36 |
...
|---|---|---|---|---|---|
| **as shipped (v1.1.0)** | 0.32 | 0.42 | -0.16 | 0.34 | 0.66 |
| E1 unpinned dependencies not assessed | 0.32 | 0.42 | -0.16 | 0.34 | 0.66 |
| E2 advisories grouped per package | 0.32 | 0.39 | -0.16 | 0.34 | 0.66 |
| E3 examples/docs weighted like tests | 0.39 | 0.44 | -0.16 | 0.34 | 0.74 |
| E4 cycles counted per component | 0.32 | 0.42 | -0.02 | 0.34 | 0.72 |
| E1–E4 combined | 0.39 | 0.41 | -0.02 | 0.34 | 0.80 |

Combined, with 95% bootstrap CIs: security 0.39 [-0.14, 0.74]; dependencies 0.41 [-0.07, 0.82]; architecture -0.02 [-0.50, 0.42]; code_health 0.34 [-0.30, 0.80]; overall 0.80 [0.54, 0.91]. Inversions: 123 (as shipped: 142).
